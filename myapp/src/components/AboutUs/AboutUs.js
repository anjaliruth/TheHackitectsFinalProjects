...
<div><p>At Paws For Affection, our mission is to connect shelters and potential adopters through our compassionate marketplace, facilitating the adoption process for dogs in need. With our innovative web app, we provide a database of available dogs, making it easier for adopters to find their perfect companion.</p></div>

<img src={sookieImage} alt="picture of a dog"/>

<div><p>We are dedicated to ensuring that every adoption is a success. Our rigorous vetting process allows us to identify qualified adopters who can provide a safe and nurturing environment for their new pet. Once approved, we refer them to their chosen shelter, reducing the burden on shelters and increasing the likelihood of successful matches.</p></div>

<img src={fridaImage} alt="picture of a dog"/>

<div><p>Our user-friendly platform minimises unnecessary visits to shelters, saving time and resources for both adopters and shelters. By streamlining the adoption process, we create a more efficient and enjoyable experience for everyone involved.</p></div>
